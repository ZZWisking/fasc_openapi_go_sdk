...
//	openId := &commonModel.OpenId{IdType: "person",OpenUserId:"8a3cb72ef85f4f62a6e82935eb41908c" }
	//signListFilter := &requestModel.SignTemplateListFilterInfo{SignTemplateName: "hangman"}
	getSignTemplateListReq := &requestModel.GetSignTemplateListReq{
		//OwnerId:openId,
		//ListFilter: signListFilter,
		//ListPageNo: 1,
	//	ListPageSize: 1,
	}
	...
	//	BankAccountNo: "",
		//Mobile:        "",
//	}
	signTaskFieldUrlReq := &requestModel.GetSignTaskFieldUrlReq{
		SignTaskId:     "1646202825361115359",
		OpenUserId:     "a1d21b1ddbfa496dbf6cdab2c854e6a0",
		//UserIdentInfo:  userIdentityInfo,
		//UserInfoExtend: userInfoExtend,
		//RedirectUrl:    "",
	}
	signTaskFieldUrlRes := c.GetSignTaskFieldUrl(signTaskFieldUrlReq,accessTokenRes.Data.AccessToken)
